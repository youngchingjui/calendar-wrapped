...
export default function Page() {
  return (
    <div className="pt-12 pb-40 bg-gradient-to-br from-purple-600 to-blue-600">
      <div className="prose prose-invert dark:prose max-w-screen-md mx-auto">
        <h1>Privacy Policy</h1>
        <p>Last updated: {new Date().toLocaleDateString()}</p>

        <h2>1. Introduction</h2>
        <p>
          Welcome to Calendar Wrapped. We respect your privacy and are committed
        ...
        <p>
          We use Google Calendar API to access your calendar data. Please refer
          to Google's Privacy Policy for information on how they handle your
          data.
        </p>

        <h2>7. Data Sharing and Disclosure</h2>
        <p>
          Your Google Calendar data is used to generate your Calendar Wrapped
          summary. This data is not stored nor shared with anyone else,
          including any third parties. No Google Calendar data or any Google
          data is stored on our databases.
        </p>
